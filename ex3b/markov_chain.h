...
typedef void (*generic_void_function__const)(const void*);
typedef void (*generic_void_function__nonconst)(void*);
typedef int (*generic_compare_function)(const void*, const void*);
typedef void* (*generic_copy_function)(const void*);
typedef bool (*generic_bool_function)(const void*);
...
typedef struct MarkovNodeFrequency {
    ...
    // appearances of this node after the node that holds this pointer
    int frequency;
} MarkovNodeFrequency;
...
typedef struct MarkovChain {
    ...
    // returns void.
    generic_void_function__const print_func;
 ...
 */
int add_node_to_frequency_list(MarkovNode *uber_node, MarkovNode
*added_node, MarkovChain *markov_chain);
